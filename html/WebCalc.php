...
<html>
    ...
    <body>
        ...
        <div id="site_web_global">
            ...
            <div id="form_calc">
                <form method="post" id="formulaire_calc" action="WebCalc.php">
                    ...
                    <div id="champ_info">
                        <label class="info_label_calc">Entrez la première Operende</label>
                    ...
                    <div id="send">
                        ...
                        <?php
                            ...
                            function resultat($result, $operande1, $operande2)
                            {
                                ...
                                {
                                    echo "<p id='resultat'>Valeurs erronées!</p>";
                                }
                                else
                                {
		...
		<div id="cmplus_footer">
            ...
            <figcaption>Etudiant à la Faculté de Genie et de nouvelle Technologie de l'université INUKA.
<br/> 3ème année Science Info</figcaption>
